<template>
	<div class="Xcharts">
		<div class="Xchartbigbox">
			<div class="buttonbox">
				<div class="button">
					<button class="xybox" @click="xchartchange"
						:style="{ backgroundColor: isshow == 1 ? '#0c7063' : '#fff',color: isshow == 1 ? '#fff' : '#0c7063'}">
						<div class="xy">横向对比</div>
					</button>
					<button class="xybox" @click="ychart"
						:style="{ backgroundColor: isshow == 2 ? '#0c7063' : '#fff',color: isshow == 2 ? '#fff' : '#0c7063'}">
						<div class="xy">纵向对比</div>
					</button>
				</div>
				<div class="typebutton">
					<button class="xybox" @click="xcharttype"
						:style="{ backgroundColor: isshows == 1 ? '#0c7063' : '#fff',color: isshows == 1 ? '#fff' : '#0c7063'}">
						<div class="xy">金额</div>
					</button>
					<button class="xybox" @click="charttype"
						:style="{ backgroundColor: isshows == 2 ? '#0c7063' : '#fff',color: isshows == 2 ? '#fff' : '#0c7063'}">
						<div class="xy">数量</div>
					</button>
				</div>
			</div>
			...
			<div class="xchartbox" v-if="isshow == 1">
				<el-form style="width: 50%;margin-left: 16px;" v-if="isshow == 1">
					<el-form-item label="采购日期:" :rules="[{ required: true, message: '采购组不能为空' }]">
			...
			<div class="ychart" v-if="isshow == 2">
				<el-form label-width="100px" class="ycharttop" id="report-input" ref="form">
					<el-form-item label="采购组:" style="width: 50%;" :rules="[{ required: true, message: '采购组不能为空' }]">
						<el-select v-model="datanews.id" filterable placeholder="请选择" style="width: 90%;" @change="currentSel"
							value-key="id">
		...
		created() {
			this.$axios
				...
				.then((res) => {
					...
					console.log(res);
					this.adminlist = res.data.purchaserList; //采购组列表
