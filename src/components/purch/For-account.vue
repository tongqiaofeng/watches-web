<template>
  <div class="for-account-container" id="for-account-container">
    <!-- <h3>待分红</h3> -->
    <div v-if="forAccountNum.num == 0" class="pending-main-con">
