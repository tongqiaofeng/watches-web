        ...
        >
            ...
            <div>
              ...
              >
                <div v-if="dialogDisposeWatchDetailsVisible == true">
                  <div
                    v-if="unCompletedSelect.isPurchaseOrSell == 'purchase'"
                    :style="{
                      color:
                        purchaseForWatchDetails.checkCost +
                          purchaseForWatchDetails.bonus.buyBonusMoney >
                        0
                          ? '#0c7063'
                          : 'red',
                      margin: '10px 0',
                  ...
                  <div
                    ...
                    :style="{
                      color:
                        purchaseForWatchDetails.bonus.sellBonusMoney > 0
                          ? '#0c7063'
                          : 'red',
                      margin: '10px 0',
                      fontSize: '18px',
                  ...
                  >
                    ...
                    <span>{{
                      formatNumberRgx(
                        purchaseForWatchDetails.bonus.sellBonusMoney
                      )
                    }}</span>
                    <span> {{ purchaseForWatchDetails.currency }}</span>
                  </div>
                    ...
                    <div style="margin-left: 20px;">
                      ...
                      <p>
                        ...
                        <span
                          ...
                          {{
                            formatNumberRgx(
                              purchaseForWatchDetails.purchase
                                .buyTaxRecvMoneyHkd
                            ) +
                              +" " +
                              purchaseForWatchDetails.currency
                      ...
                      <p>
                        ...
                        <span>{{
                          formatNumberRgx(
                            purchaseForWatchDetails.purchase.cost
                          ) +
                            +" " +
                            purchaseForWatchDetails.currency
                        }}</span>
                  ...
                  <div>
                    ...
                    <div style="margin-left: 20px;">
                      <p>
                        <span
                          v-if="
                            unCompletedSelect.isPurchaseOrSell == 'purchase'
                          "
                          >核算</span
                        >成本：<span>{{
                    ...
                    <div style="margin-left: 20px;">
                      <p>
                        总利润：<span>{{
                          formatNumberRgx(
                            purchaseForWatchDetails.sellMoney -
                              purchaseForWatchDetails.checkCost
                          ) +
                            " " +
                            purchaseForWatchDetails.currency
          ...
          <div>
            <div class="flex-style">
              <p>
                批发价：<span>{{
                  formatNumberRgx(watch.marketPrice) +
                    " " +
                    watch.marketCurrency
                }}</span>
              </p>
              <p>
                售价：<span>{{
        ...
        <div v-show="purchaseBonusDetails.state == 1">
          <div class="debtMsg" v-show="purchaseBonusDetails.deductMoney !== 0">
            ...
            <div>
              <p>抵扣港币金额设置：</p>
              <div
                v-for="(debt, index) in purchaseBonusDetails.debtMsg"
                :key="index"
                style="display: flex;"
              >
                <div>
                  ...
                  <el-input
                    ...
                    v-model="deductList[index].moneyHkd"
                    @input="moneyHKDChange(index)"
                    ><i
                      slot="suffix"
                  ...
                  >
                  <span
                    >可抵扣：<span>{{ debt.moneyHkd }}</span> HKD</span
                  >
                </div>
              </div>
            </div>
          ...
          <div style="text-align: center;">
            <p style="color: red;">
              提示：如果没有收到分红，请不要进行确认操作，并及时与财务联系
            </p>
            <el-button type="primary" @click="checkBonusForm"
              >已收到分红</el-button
            >
            <el-dialog
              title="收到分红确认"
              :visible.sync="dialogCheckBonusFormVisible"
              center
            >
              <div style="text-align: center;">
                <p>确认已收到分红？确认后不可修改</p>
              ...
              <div slot="footer">
                <el-button @click="dialogCheckBonusFormVisible = false"
                  >取 消</el-button
                >
                <el-button type="primary" @click="checkBonusFormSure"
                  >确 定</el-button
                >
              </div>
            </el-dialog>
...
export default {
  ...
  methods: {
    ...
    checkBonusFormSure() {
      this.$axios
        .post(this.$store.state.baseUrl + "/checkBonusForm?java", {
          id: this.bonusId,
    ...
    getList() {
      ...
      this.list = this.unCompletedList.filter(
        (item, index) =>
