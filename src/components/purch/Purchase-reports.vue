<template>
  <div class="Purchase-report" id="Purchase-report">
    <div class="report-center" v-if="againclick.times == 0">
          ...
          <el-form id="report-input" ref="form" :label-position="labelPosition">
            <div class="report-input">
              ...
              <el-form-item
                label="采购组:"
                style="width: 50%;"
                :rules="[{ required: true, message: '采购组不能为空' }]"
                v-if="authorityList[32] == 1"
              >
                <el-select
                  v-model="backnicks.id"
                  filterable
                  placeholder="请选择"
                  style="width: 90%;"
                  @change="currentSel"
              ...
              <!-- 采购组 无权限-->
              <!-- <el-form-item label="采购组:" style="width: 50%;" :rules="[{ required: true, message: '采购组不能为空' }]"
                v-if="authorityList[32] != 1">
      ...
      <div class="report-center2">
        <div class="report-showlist">
            ...
            <div class="watch-nums">
              ...
              <div class="watch-sale-type" v-show="saletypenum == 0">
                <div class="watch-sale">
                  <p>已出售 :</p>
                  <p>{{ reportlist.sellTotal }}</p>
                </div>
                <div class="watch-sale">
                  <p>未出售 :</p>
                  <p>{{ reportlist.unSellTotal }}</p>
                </div>
              </div>
            </div>
            <div class="watch-nums">
              <div class="watch-salenums">
                ...
                <p class="watch-nums-total">
                  ...
                  {{
                    formatNumberRgx(reportlist.allMoney) +
                      " " +
                      reportlist.currency
                  }}
                </p>
              ...
              <div class="watch-sale-type" v-show="saletypenum == 0">
                <div class="watch-sale">
                  ...
                  <p>
                    {{
                      formatNumberRgx(reportlist.sellMoney) +
                        " " +
                        reportlist.currency
                    }}
                  </p>
                ...
                <div class="watch-sale">
                  ...
                  <p>
                    {{
                      formatNumberRgx(reportlist.unSellMoney) +
                        " " +
                        reportlist.currency
                    }}
                  </p>
          ...
          <div class="excel" v-show="imgurl.length !== 0">
  ...
  methods: {
    ...
    buyersid() {
      this.$axios
        ...
        .then((res) => {
          this.adminlist = res.data.purchaserList;
          this.flagSel = res.data.flag;
...
.watch-sale-type > .watch-sale:first-of-type {
  margin-left: 30px;
}
