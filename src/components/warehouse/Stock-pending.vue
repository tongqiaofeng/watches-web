    ...
    <div class="pending-container">
      ...
      <table class="pending-table">
        ...
        <tr v-for="(items, index) in watchList" :key="index">
          ...
          <td>
            <el-button type="text" @click="pendingButton(items, index)"
              >入库</el-button
            >
            <el-dialog
              title="入库"
              :visible.sync="dialogPendingVisible"
            ...
            >
              <div style="text-align: left;">
                <div>
                  <el-form label-width="120px" style="padding-top: 10px;">
                    <el-form-item label="采购员：" v-if="isConsignment == true">
                      <el-select
                        v-model="buyUserId"
                        placeholder="请选择"
                        style="width: 60%;"
                      ...
                      <div class="upload-imgs">
                        <div class="add">
                          ...
                          >
                            <input
                              @change="
                                inputChange($event, items.buyWatchSn, items.id)
                              "
                              type="file"
                              name="img"
                              accept="image/*"
              ...
              <div slot="footer">
                ...
                <el-button @click="dialogPendingVisible = false"
                  >取 消</el-button
                >
                <el-button type="primary" @click="stockSure" v-preventClick
                  >确 定</el-button
                >
              </div>
            </el-dialog>
      ...
      if (this.verification() !== 1) {
        ...
        this.$axios
          .post(this.$store.state.baseUrl + "/StockInDo", {
            id: this.purchId,
            buyUserId: this.isConsignment == true ? this.buyUserId : null,
            stockInstateA: this.stockInstateA,
            stockShelfNoA: this.stockShelfNoA,
            stockInPic: storeImgUrl4,
          })
          .then((res) => {
            console.log("手表入库");
            console.log(res);
