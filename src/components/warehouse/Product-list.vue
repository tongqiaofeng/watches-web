  ...
  <div class="product-list-container">
    <div class="product-container">
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  {{items.logState == 0 ? '采购中' : (items.logState == 1 ? '运输中' : '已入库')}}
                </td>
                <td>
                  {{items.sellState == 1 ? '已出售' : '未出售'}}
                </td>
                <td>
      ...
      <div v-if="deliveryList.delivery == 1" class="list-details">
        ...
        <div style="margin: 0 auto;display: flex;flex-wrap: wrap;justify-content: center;" class="style-margin">
          <!--  + '/img/watch/' -->
        ...
        <div class="list-top">
          ...
          <div class="style-margin" style="display: flex;">
            ...
            <div @click="updateStockShelfNoA" style="width: 55px;cursor: pointer;">
              <img src="../../assets/imgs/update.png" style="width: 20px;height: 20px;margin-right: 0.5%;" />
              <span style="color: #0aa1ed;font-size: 15px;">修改</span>
            </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      // 返回手表列表
      gobackDeliveryOne() {
        if (this.deliveryList.isMe == 1) {
          this.$emit('goBackDelivery', 0);
        } else {
      ...
      getQRCode() {
        this.$axios.post('http://127.0.0.1:8079', {
          ...
          CMDDATA: this.buyWatchBrand + '`' + this.buyWatchModel + '`' + this.stockNo + '-A`' + this.stockNo +
            '-A|' + this.stockNoCrc
        }).then((res) => {
          console.log(res);
          this.$message.success({
