  ...
  <div class="rate-query-container">
    ...
    <div class="rate-query" v-if="rateQuerySel.select == 0">
      ...
      <div class="rate-query-top">
        ...
        <el-dialog
          title="价格计算器"
          :visible.sync="dialogCalcVisible"
          center
        ...
        >
          ...
          <div slot="footer">
            ...
            <el-button type="primary" @click="dialogCalcVisible = false"
              >确 定</el-button
            >
          </div>
        </el-dialog>
            ...
            <table>
              ...
              <tr v-for="(rate, index) in dataRateList" :key="index">
                ...
                <td v-show="rate.type == 0">
                  <span>{{ rate.rate }}</span>
                  <img
                    v-show="rate.change !== 0"
                    :src="rate.change == 1 ? img1 : img2"
    ...
    <div v-if="rateQuerySel.select == 1">
      ...
      <table style="width: 86%;margin: auto;">
        ...
        <tr
          v-if="isshowtabel == 1"
          v-for="(item, index) in dataRateHistoryreverse"
          :key="index"
          style="height: 48px;"
        >
          <td>{{ item.time }}</td>
        ...
        <tr
          v-if="isshowtabel == 2"
          v-for="(item, index) in moneyShopHistoryreverse"
          :key="index"
          style="height: 48px;"
        >
          <td>{{ item.time }}</td>
