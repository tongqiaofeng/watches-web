<template>
  <div class="watch-query-container" id="watch-query">
      ...
      <div class="watch-query-chose">
        <div class="watch-select">
          <div style="display: flex;">
            ...
            <el-button class="showwatch" @click="choosewatchmessage"
              >选择手表信息</el-button
            >
          </div>
          <el-dialog
          ...
          >
            <div>
              <div class="watch-name">
                <div style="font-size: 16px;">品牌</div>
                <div style="margin:20px; position: relative;">
                  <el-checkbox-group
                    v-model="arrbrand"
                    @change="selectGoodsByGroupId($event)"
                  >
                    <div :class="{ branstyle: isshowcheck }">
                      <el-checkbox-button
                        @change="allstockInSearch($event)"
                        class="all-style"
                        >全部</el-checkbox-button
                      >
                      <el-checkbox-button
                        v-for="(item, index) in watchBrandList"
                        @change="checkboxbutton(arrbrand, index)"
                        :key="index"
                        :label="item.name"
                      ></el-checkbox-button>
                    </div>
              ...
              <div class="watch-name" v-if="seriesList[0].length != undefined">
                <div style="font-size: 16px;">系列</div>
                <div style="margin:20px;">
                  <el-checkbox-group
                    v-model="arrseries"
                    @change="seriesChange()"
                  >
                    <div :class="{ branstyle: isshowcheck2 }">
                      <el-checkbox-button
                        @change="allstockInSearch2"
                        class="all-style2"
                        >全部</el-checkbox-button
                      >
                      <el-checkbox-button
                        v-for="(items, index) in seriesList"
                        @change="checkboxbuttonseries(arrseries, index)"
                        :key="index"
                        :label="items"
                      >
                      </el-checkbox-button>
            ...
            <div class="watch-price">
              <div style="font-size: 16px;">价格</div>
              <div style="margin:20px;margin: 20px;">
                ...
                <div style="margin:10px auto;text-align: center;" v-else>
                  {{
                    value2[0] + "   " + "万" + "~" + value2[1] + "   " + "万"
                  }}
                </div>
                <el-slider
                  v-model="value2"
              ...
              <div style="margin:42px 26px 0;">
                <el-checkbox-group v-model="pricestype">
                  <el-checkbox-button :label="1">采购价</el-checkbox-button>
                  <el-checkbox-button :label="2">批发价</el-checkbox-button>
                  <el-checkbox-button :label="3">市场价</el-checkbox-button>
                  <el-checkbox-button :label="4">销售价</el-checkbox-button>
                </el-checkbox-group>
              </div>
              <div
                style="margin:10px auto;display: flex;justify-content: space-around;"
              >
                <div style="margin:0 16px;">
                  <span>公价价格</span>
                  <input type="text" v-model="publicPrice" class="rate-input" />
                </div>
                <div style="margin:0 16px;" class="publicPriceArea">
                  <span>公价国家</span>
                  <el-select
            ...
            <div class="watch-type ">
              <div style="font-size: 16px;">机芯类型</div>
              <el-checkbox-group
                v-model="buyWatchSn"
                style="margin:20px;margin: 20px;"
              >
                <el-checkbox-button label="自动机械"></el-checkbox-button>
                <el-checkbox-button label="手动机械"></el-checkbox-button>
                <el-checkbox-button label="石英"></el-checkbox-button>
                <el-checkbox-button label="光能"></el-checkbox-button>
                <el-checkbox-button label="智能"></el-checkbox-button>
                <el-checkbox-button label="电子"></el-checkbox-button>
              </el-checkbox-group>
            </div>
            <div class="watch-type">
              <div style="font-size: 16px;">适用人群</div>
              <el-checkbox-group
                v-model="suitPeople"
                style="margin:20px;margin: 20px;"
              >
                <el-checkbox-button
                  class="watch-name-button"
                  label="男士"
                ></el-checkbox-button>
                <el-checkbox-button
                  class="watch-name-button"
            ...
            <div class="watch-type">
              <div style="font-size: 16px;">功能</div>
              <el-checkbox-group
                v-model="funtionval"
                style="margin:20px;margin: 20px;"
              >
            ...
            <div class="watch-type">
              <div style="font-size: 16px;">表盘颜色</div>
              <el-checkbox-group
                style="margin:20px;margin: 20px;"
                v-model="watchscolor"
              >
            ...
            <div class="watch-type">
              <div style="font-size: 16px;">表壳材质</div>
              <el-checkbox-group
                style="margin:20px;margin: 20px;"
                v-model="caseMaterial"
              >
                <el-checkbox-button
            ...
            <div class="watch-type">
              <div style="font-size: 16px;">上市年份</div>
              <div style="margin:20px;margin: 20px;">
            ...
            <span slot="footer" class="fixedbutton">
              <el-button @click="chooseisnot">取 消</el-button>
              <el-button type="primary" @click="chooseisok">确 定</el-button>
            </span>
          </el-dialog>
          <div v-show="watchAuthority[6] == 1">
            <div @click="addWatch" class="addBtn">
              <span class="add-style"> <span>+</span> 增加手表 </span>
            </div>
            <el-dialog
              class="watch-chose"
              title="增加手表"
              :visible.sync="dialogAddWatchVisible"
              center
            ...
            >
                  ...
                  <el-form label-width="150px">
                      ...
                      <div style="display:flex;">
                        <div class="upload-imgs">
                          ...
                          >
                            ...
                            >
                              <span class="spanStyle" @click="delImage(index)"
                                >x</span
                              >
                              <img
                    ...
                    >
                      <div style="width: 100%;">
                        ...
                        <el-button
                          type="primary"
                          style="width: 100px;height: 40px;font-size: 14px;"
              ...
              <div slot="footer">
                <el-button @click="dialogAddWatchVisible = false"
                  >取 消</el-button
                >
                <el-button type="primary" @click="addWatchSure" v-preventClick
                  >确 定</el-button
                >
              </div>
            </el-dialog>
        ...
        <div style="color: #919090; font-size: 14px;margin: 10px 25px 0;">
          {{ "共" + total + "支手表" }}
        </div>
      </div>
              ...
              <tr v-for="(item, index) in watchList" :key="index">
                <td>
                  ...
                  <img
                    ...
                    class="img-style"
                    :src="
                      item.pics == null || item.pics == ''
                        ? ''
                        : img + '/img/watch/' + item.pics.split('|')[0]
                    "
                  />
                </td>
                <td>{{ item.brand }}</td>
      ...
      <div class="watch-details-center">
        <div style="width: 60%;margin: 0 auto;">
          ...
          <div>
            <p>
              品牌型号：{{
                watchSelectDetails.brand + " - " + watchSelectDetails.model
              }}
            </p>
          </div>
          <div>
            ...
            <div style="width: 90%;margin: 0 auto;">
              ...
              <div style="display: flex;">
                <p>
                  批发价：
                  {{
                    watchSelectDetails.marketPrice == 0 ||
                    watchSelectDetails.marketPrice == null
                      ? "暂无"
                      : formatNumberRgx(watchSelectDetails.marketPrice) +
                        " " +
                        watchSelectDetails.marketCurrency
                  }}
                </p>
                <p
                  style="margin-left: 15px;color: #0aa1ed;cursor: pointer;"
                  v-show="
                    (watchSelectDetails.marketPrice !== 0 &&
                      watchSelectDetails.marketPrice !== null) ||
                      watchAuthority[11] == 1
                  "
                  @click="priceDetailsJump"
                >
                  批发价详情
                </p>
              </div>
              <div style="display: flex;">
                <p>
                  市场价：{{
                    watchSelectDetails.bazaarPrices.length == 0
                      ? "暂无"
                      : formatNumberRgx(
                          watchSelectDetails.bazaarPrices[0].price
                        ) +
                        " " +
                        watchSelectDetails.bazaarPrices[0].currency
                  }}
                </p>
                <p
                  style="margin-left: 15px;color: #0aa1ed;cursor: pointer;"
                  v-show="
                    watchSelectDetails.bazaarPrices.length !== 0 ||
                      watchAuthority[26] == 1
                  "
                  @click="bazaarPricesDetailsJump(watchSelectDetails)"
                >
                  市场价详情
                </p>
              </div>
              <div style="display: flex;">
                <p>
                  销售价：{{
                    watchSelectDetails.sellPrices.length == 0
                      ? "暂无"
                      : formatNumberRgx(
                          watchSelectDetails.sellPrices[0].price
                        ) +
                        " " +
                        watchSelectDetails.sellPrices[0].currency
                  }}
                </p>
                <p
                  style="margin-left: 15px;color: #0aa1ed;cursor: pointer;"
                  v-show="watchSelectDetails.sellPrices.length !== 0"
                  @click="sellPricesDetailsJump(watchSelectDetails.sellPrices)"
                >
                  销售价详情
                </p>
              </div>
              <p>公价：</p>
              <div v-if="watchSelectDetails.publicPriceArea !== ''">
                <div
                  style="width: 90%;margin: 0 auto;"
                  v-for="(area,
                  index) in watchSelectDetails.publicPriceArea.split('|')"
                  :key="index"
                >
                  <div
                    v-for="(price,
                    index2) in watchSelectDetails.publicPrice.split('|')"
                    :key="index2"
                  >
                    <p v-show="index === index2 && area !== ''">
                      <span
                        >{{ area }}：<span style="margin-left: 5px;">{{
                          price
                        }}</span></span
                      >
                    </p>
          ...
          <div>
            ...
            <div style="width: 90%;margin: 0 auto;">
              <h4>基本信息：</h4>
              <div style="width: 90%;margin: 0 auto;">
                <p v-show="watchSelectDetails.series !== ''">
                  系列：{{ watchSelectDetails.series }}
                </p>
                <p v-show="watchSelectDetails.crowd !== ''">
                  适用人群：{{ watchSelectDetails.crowd }}
                </p>
                <p v-show="watchSelectDetails.style !== ''">
                  风格：{{ watchSelectDetails.style }}
                </p>
                <p v-show="watchSelectDetails.transparent !== ''">
                  是否背透：{{ watchSelectDetails.transparent }}
                </p>
                <p v-show="watchSelectDetails.limited !== ''">
                  是否限量：{{ watchSelectDetails.limited }}
                </p>
                <p v-show="watchSelectDetails.limitedNum !== ''">
                  限量版个数：{{ watchSelectDetails.limitedNum }}
                </p>
                <p v-show="watchSelectDetails.special !== ''">
                  特别版：{{ watchSelectDetails.special }}
                </p>
                <p v-show="watchSelectDetails.waterproofEn !== ''">
                  是否防水：{{ watchSelectDetails.waterproofEn }}
                </p>
                <p v-show="watchSelectDetails.waterproof !== ''">
                  防水深度：{{ watchSelectDetails.waterproof }}
                </p>
                <p v-show="watchSelectDetails.watchNick !== ''">
                  昵称简称：{{ watchSelectDetails.watchNick }}
                </p>
                <p v-show="watchSelectDetails.startYear !== ''">
                  上市年份：{{ watchSelectDetails.startYear }}
                </p>
                <p v-show="watchSelectDetails.endYear !== ''">
                  停产年份：{{ watchSelectDetails.endYear }}
                </p>
                <p v-show="watchSelectDetails.famous !== ''">
                  名人同款：{{ watchSelectDetails.famous }}
                </p>
                <p v-show="watchSelectDetails.func !== ''">
                  功能：{{ watchSelectDetails.func }}
                </p>
                <p
                  v-show="watchSelectDetails.des !== ''"
                  style="display: flex;"
                >
                  <span>手表描述：{{ watchSelectDetails.des }}</span>
                </p>
              </div>
              <h4>表壳：</h4>
              <div style="width: 90%;margin: 0 auto;">
                <p v-show="watchSelectDetails.watchShellSize !== ''">
                  表壳直径：{{ watchSelectDetails.watchShellSize }}
                </p>
                <p v-show="watchSelectDetails.watchShellWidth !== ''">
                  表壳宽度：{{ watchSelectDetails.watchShellWidth }}
                </p>
                <p v-show="watchSelectDetails.watchShellHeight !== ''">
                  表壳高度：{{ watchSelectDetails.watchShellHeight }}
                </p>
                <p v-show="watchSelectDetails.watchThickness !== ''">
                  表壳厚度：{{ watchSelectDetails.watchThickness }}
                </p>
                <p v-show="watchSelectDetails.glassMaterial !== ''">
                  表镜材质：{{ watchSelectDetails.glassMaterial }}
                </p>
                <p v-show="watchSelectDetails.shellMaterial !== ''">
                  表壳材质：{{ watchSelectDetails.shellMaterial }}
                </p>
                <p v-show="watchSelectDetails.bezelMaterial !== ''">
                  表圈材质：{{ watchSelectDetails.bezelMaterial }}
                </p>
                <p v-show="watchSelectDetails.crownMaterial !== ''">
                  表冠材质：{{ watchSelectDetails.crownMaterial }}
                </p>
              </div>
              <h4>表盘：</h4>
              <div style="width: 90%;margin: 0 auto;">
                <p v-show="watchSelectDetails.dialShape !== ''">
                  表盘形状：{{ watchSelectDetails.dialShape }}
                </p>
                <p v-show="watchSelectDetails.dialMark !== ''">
                  表盘刻度：{{ watchSelectDetails.dialMark }}
                </p>
                <p v-show="watchSelectDetails.dialSize !== ''">
                  表盘直径：{{ watchSelectDetails.dialSize }}
                </p>
                <p v-show="watchSelectDetails.dialNick !== ''">
                  表盘昵称：{{ watchSelectDetails.dialNick }}
                </p>
                <p v-show="watchSelectDetails.dialCraft !== ''">
                  表盘工艺：{{ watchSelectDetails.dialCraft }}
                </p>
                <p v-show="watchSelectDetails.dialClr !== ''">
                  表盘颜色：{{ watchSelectDetails.dialClr }}
                </p>
                <p v-show="watchSelectDetails.dialMaterial !== ''">
                  表盘材质：{{ watchSelectDetails.dialMaterial }}
                </p>
              </div>
              <h4>表带表扣：</h4>
              <div style="width: 90%;margin: 0 auto;">
                <p v-show="watchSelectDetails.claspType !== ''">
                  表扣类型：{{ watchSelectDetails.claspType }}
                </p>
                <p v-show="watchSelectDetails.bandMaterial !== ''">
                  表带材质：{{ watchSelectDetails.bandMaterial }}
                </p>
                <p v-show="watchSelectDetails.bandClr !== ''">
                  表带颜色：{{ watchSelectDetails.bandClr }}
                </p>
              </div>
              <h4>机芯：</h4>
              <div style="width: 90%;margin: 0 auto;">
                <p v-show="watchSelectDetails.movementType !== ''">
                  机芯类型：{{ watchSelectDetails.movementType }}
                </p>
                <p v-show="watchSelectDetails.movementModel !== ''">
                  机芯型号：{{ watchSelectDetails.movementModel }}
                </p>
                <p v-show="watchSelectDetails.movementSize !== ''">
                  机芯直径：{{ watchSelectDetails.movementSize }}
                </p>
                <p v-show="watchSelectDetails.jewelNum !== ''">
                  机芯宝石数：{{ watchSelectDetails.jewelNum }}
                </p>
                <p v-show="watchSelectDetails.powerTime !== ''">
                  动力存储：{{ watchSelectDetails.powerTime }}小时
                </p>
                <p v-show="watchSelectDetails.frequency !== ''">
                  机芯振频：{{ watchSelectDetails.frequency }}
                </p>
                <p v-show="watchSelectDetails.movementDes !== ''">
                  <span style="width: 110px;">机芯描述：</span>
                  <span>{{ watchSelectDetails.movementDes }}</span>
                </p>
              </div>
            </div>
          </div>
    ...
    <div>
      <Bazar-prices-details
        v-if="watchQuerySel.select == 3"
        :priceDetailsList="priceDetailsList"
        @gobackPriceAdmin="gobackPriceAdmin"
      ></Bazar-prices-details>
    </div>
...
export default {
  ...
  props: ["watchQuerySel", "notoqyeryval"],
  created() {
  ...
  mounted() {
    ...
    if (this.notoqyeryval.num != 0) {
      this.watchDetails(this.notoqyeryval.val);
    }
    this.yyyy = new Date().getFullYear();
    for (let i = 0; i <= 5; i++) {
      this.yyyylist.push(this.yyyy - i);
    }
    this.yyyylist.push(this.yyyylist[5] + "以前");
  },
  methods: {
    choosewatchmessage() {
      this.dialogVisible = true;
      this.isshowcheck = false;
      this.isshowcheck2 = false;
      if (this.arrbrand.length == 1) {
        this.selectGoodsByGroupId(this.arrbrand); //品牌--系列联动
      }
      if (this.isclick == true) {
        if (this.temparrbrand.length == this.watchBrandListname.length) {
          //点开后变绿的情况--选中的length==arrbrand.length
          document.getElementsByClassName(
            "all-style"
          )[0].children[1].style.backgroundColor = "#0c8563";
          document.getElementsByClassName(
            "all-style"
          )[0].children[1].style.color = "#fff";
        } else {
          document.getElementsByClassName(
            "all-style"
          )[0].children[1].style.backgroundColor = "#f5f4f3";
          document.getElementsByClassName(
            "all-style"
          )[0].children[1].style.color = "#919090";
        }
      } else if (this.isclick2 == true) {
        if (this.temparrseries.length == this.seriesList.length) {
          //点开后变绿的情况--选中的length==arrseries.length
          document.getElementsByClassName(
            "all-style2"
          )[0].children[1].style.backgroundColor = "#0c8563";
          document.getElementsByClassName(
      ...
      if (val.length == 1) {
        for (let index in this.watchBrandList) {
          if (this.watchBrandList[index].name == val) {
            ...
            // console.log(this.temparrbrand);
            // console.log(this.arrbrand);
            if (this.temparrbrand[0] != this.arrbrand[0]) {
              this.arrseries = []; //第二次选择时，没有选择系列，将系列清空，重新选择系列
            }
          }
        }
      } else {
    ...
    allstockInSearch(e) {
      //品牌--全部
      this.arrbrand = this.watchBrandListname;
      this.isclick = true;
      console.log(this.arrbrand);
      if (this.isshowcheck == false) {
        ...
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.backgroundColor = "#0c8563"; //绿
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.color = "#fff";
        console.log("全部品牌" + this.isshowcheck);
      } else {
        this.isshowcheck = false;
        this.arrbrand = [];
        ...
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.backgroundColor = "#f5f4f3"; //灰
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.color = "#919090";
        console.log("全部品牌" + this.isshowcheck);
    ...
    allstockInSearch2() {
      //系列--全部
      this.arrseries = this.seriesList;
      this.isclick2 = true;
      if (this.isshowcheck2 == false) {
        this.isshowcheck2 = true;
        console.log("false ----true");
        document.getElementsByClassName(
          "all-style2"
        )[0].children[1].style.backgroundColor = "#0c8563";
        ...
        console.log("全部系列" + this.isshowcheck);
      } else {
        this.isshowcheck2 = false;
        this.arrseries = [];
        document.getElementsByClassName(
    ...
    closedialog() {
      this.arrbrand = this.temparrbrand;
      this.arrseries = this.temparrseries;
      this.buyWatchSn = this.tempbuyWatchSn;
      this.suitPeople = this.tempsuitPeople;
      this.funtionval = this.tempfuntionval;
      this.watchscolor = this.tempwatchscolor;
      this.caseMaterial = this.tempcaseMaterial;
      this.year = this.tempyear;
      if (this.tempvalue2.length == 0) {
        //价格在确认后，保留数据，其他情况显示默认状态
        this.value2 = [0, 1000];
      } else {
        this.value2 = this.tempvalue2;
      }
    ...
    chooseisok() {
      //确定按钮保存选项
      this.temparrbrand = this.arrbrand;
      this.temparrseries = this.arrseries;
      this.tempbuyWatchSn = this.buyWatchSn;
      this.tempsuitPeople = this.suitPeople;
      this.tempfuntionval = this.funtionval;
      this.tempwatchscolor = this.watchscolor;
      this.tempcaseMaterial = this.caseMaterial;
      this.tempyear = this.year;
      this.tempvalue2 = this.value2;
      this.dialogVisible = false;
      this.watchSearchCheck();
    },
    checkboxbutton(val, index) {
      console.log(index);
      console.log(this.arrbrand);
      if (this.isshowcheck == true) {
        this.isshowcheck = false;
        document.getElementsByClassName("branstyle")[0].children[
          index + 1
        ].children[1].style.backgroundColor = "#f5f4f4";
        document.getElementsByClassName(
          "branstyle"
        )[0].children[0].children[1].style.backgroundColor = "#f5f4f4";
        document.getElementsByClassName(
          "branstyle"
      ...
      if (this.watchBrandListname.length == val.length) {
        ...
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.backgroundColor = "#f5f4f4";
        document.getElementsByClassName(
          "all-style"
        )[0].children[1].style.color = "#919090";
      }
    },
    checkboxbuttonseries(val, index) {
      console.log(val);
      this.isclick2 = true;
      if (this.isshowcheck2 == true) {
        this.isshowcheck2 = false;
        document.getElementsByClassName("branstyle")[0].children[
          index + 1
        ].children[1].style.backgroundColor = "#f5f4f4";
    ...
    //手表搜索—复选框搜索
    watchSearchCheck() {
      this.upPrice = Number(this.value2[1] + "0000");
      if (this.value2[1] == 1000) {
        this.upPrice = "";
      } else {
      ...
      this.hintMsg = "数据加载中...";
      this.$axios
        .post(this.$store.state.baseUrl + "/watchSearchCheck?java", {
          brand: this.arrbrand,
          series: this.arrseries,
          buyWatchSn: this.buyWatchSn,
          suitPeople: this.suitPeople,
          funtion: this.funtionval,
          color: this.watchscolor,
          downPrice: this.downPrice,
          upPrice: this.upPrice,
          caseMaterial: this.caseMaterial,
          listedYear: this.year,
          keyword: this.keyword,
          prices: this.pricestype,
          publicPrice: this.publicPrice,
          publicPriceArea: this.publicPriceArea,
          page: this.page,
    ...
    updatePrice(index) {
      console.log(index);
      console.log(
        this.publicPriceList[index].country,
    ...
    addWatchSure() {
      if (this.verify() !== 1) {
        ...
        this.$axios
          .post(this.$store.state.baseUrl + "/WatchSave?java", {
            brand: this.addBrand,
    ...
    watchDetails(id) {
      this.detailsId = id;
      this.$axios
        .post(this.$store.state.baseUrl + "/WatchInfo?java", {
          id: this.detailsId,
        })
        .then((res) => {
          console.log("手表详细信息");
    ...
    priceDetailsJump() {
      ...
      this.$axios
        .post(this.$store.state.baseUrl + "/DataMaketPrice", {
    ...
    gobackWatchList() {
      ...
      if (this.notoqyeryval.num == 1) {
        console.log("11");
        this.$emit(
          "nottoquery",
          0,
          this.notoqyeryval.val,
          1,
          this.notoqyeryval.page
        );
      } else if (this.notoqyeryval.num == 2) {
        console.log("22");
        this.$emit(
          "nottoquery",
          0,
      ...
      if (this.verify() !== 1) {
        ...
        this.$axios
          .post(this.$store.state.baseUrl + "/WatchSave?java", {
            ...
            bezelMaterial: Array.from(new Set(this.bezelMaterialList)).join(
              "|"
            ),
            crownMaterial: Array.from(new Set(this.crownMaterialList)).join(
              "|"
            ),
            dialShape: this.dialShape,
            dialMark: this.dialMark,
            ...
            dialClr: Array.from(new Set(this.dialClrList)).join("|"),
            dialMaterial: Array.from(new Set(this.dialMaterialList)).join("|"),
            claspType: this.claspType,
            bandMaterial: this.bandMaterial,
            bandClr: Array.from(new Set(this.bandClrList)).join("|"),
            movementType: this.movementType,
            movementModel: this.movementModel,
            movementSize: this.movementSize,
            jewelNum: this.jewelNum,
    ...
    handleDataWatchBrandList() {
      this.$axios
        ...
        .then((res) => {
          ...
          console.log(this.watchBrandList);
          for (let i = 0; i < this.watchBrandList.length; i++) {
            this.watchBrandListname.push(this.watchBrandList[i].name);
          }
...
.watch-chose {
  ...
  .publicPriceArea .el-input__inner {
    height: 40px;
    width: 280px;
    margin-left: 10px;
    border-radius: 30px;
