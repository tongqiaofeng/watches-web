        ...
        <el-tab-pane label="待处理" name="one">
            ...
            <div v-if="pendingList.length !== 0">
              <table>
                ...
                <tr v-for="(item,index) in pendingList" :key="index">
                  ...
                  <td>{{formatNumberRgx(item.sysCheckMoney) + ' ' + item.settleCurrency}}</td>
                  <td>
          ...
          <div v-if="reimbursementAdminSel.select == 1">
            ...
            <div style="width: 95%;margin: 0 auto;">
              ...
              <p>
                <span>预估报销金额：<span>{{formatNumberRgx(reimburseDetailsMsg.sysCheckMoney) + ' ' + reimburseDetailsMsg.settleCurrency}}</span></span>
              </p>
              <p>
                <span>核算报销金额：<span>{{reimburseDetailsMsg.checkMoney == null ? '' : formatNumberRgx(reimburseDetailsMsg.checkMoney) + ' ' + reimburseDetailsMsg.settleCurrency}}</span></span>
              </p>
            </div>
            <div style="width: 95%;margin: 0 auto;margin-top: 30px;">
              ...
              <table v-for="(reim,index) in reimburseDetailsMsg.data" :key="index">
                ...
                <tr>
                  <td>
                    <img :src="reim.type | imgFilter(reim.obj.type)" style="width: 40px;height: 40px;" />
                  </td>
                  <td>{{reim.type == 0 ? reim.obj.name : reim.obj.type}}</td>
                  <td>

                    {{reim.obj.checkMoney == null ? '待核算' : formatNumberRgx(reim.obj.checkMoney) + ' ' + reimburseDetailsMsg.settleCurrency}}
                  </td>
                  <td>
                      ...
                      <div>
                        ...
                        <div style="margin-top: 20px;border-top: 1px solid #ddd;">
                          ...
                          <div style="display: flex;justify-content: space-between;">
                            ...
                            <img src="../../assets/imgs/calc2.png" style="height: 35px;cursor: pointer;"
                              @click="jumpRate(unJourneyInfo.rateTime)" />
                          </div>
                          ...
                          <p>
                            ...
                            预估报销金额：<span>{{unJourneyInfo.sysCheckMoney == 0 || unJourneyInfo.sysCheckMoney == null ? '' : formatNumberRgx(unJourneyInfo.sysCheckMoney) + ' ' + unJourneyInfo.settleCurrency}}</span>
                          </p>
                          <div>
                            <span>核算报销金额：</span>
                            <el-input style="width: 50%;height: auto;line-height: 40px;" v-model="calculationAmount">
                              <i slot="suffix"
                                ...
                                style="color: #000;margin-right:5%;font-style:normal;">{{unJourneyInfo.settleCurrency}}</i>
                            </el-input>
                          </div>
                        </div>
                      </div>
          ...
          <div v-if="reimbursementAdminSel.select == 2">
              ...
              <table>
                ...
                <tr v-for="(every,index) in journeyInfo.recordList" :key="index">
                  ...
                  <td>
                    ...
                    {{every.checkMoney == 0 || every.checkMoney == null ? '待核算' : formatNumberRgx(every.checkMoney) + ' ' + journeyInfo.settleCurrency}}
                  </td>
                  <td>{{every.time}}</td>
                  <td>
                    <el-tooltip class="item" effect="light" content="核算金额" placement="top-end">
                      ...
                      <div>
                        ...
                        <div style="margin-top: 20px;border-top: 1px solid #ddd;">
                          ...
                          <div style="display: flex;justify-content: space-between;">
                            ...
                            <img src="../../assets/imgs/calc2.png" style="height: 35px;cursor: pointer;"
                              @click="jumpRate(recordDetailsMsg.rateTime)" />
                          </div>
                          <p style="margin-top: 0;">
                          ...
                          <p>
                            ...
                            预估报销金额：<span>{{recordDetailsMsg.sysCheckMoney == 0 || recordDetailsMsg.sysCheckMoney == null ? '' : formatNumberRgx(recordDetailsMsg.sysCheckMoney) + ' ' + journeyInfo.settleCurrency}}</span>
                          </p>
                          <div>
                            <span>核算报销金额：</span>
                            <el-input style="width: 50%;height: auto;line-height: 40px;" v-model="calculationAmount">
                              <i slot="suffix"
                                ...
                                style="color: #000;margin-right:5%;font-style:normal;">{{journeyInfo.settleCurrency}}</i>
                            </el-input>
                          </div>
                        </div>
                      </div>
            ...
            <div style="width: 95%;margin: 0 auto;">
              ...
              <p style="margin-left: 20px;">
                预估报销金额：<span>{{journeyInfo.sysCheckMoney + ' ' + journeyInfo.settleCurrency}}</span></p>
              <p style="margin-left: 20px;">
                核算报销金额：<span>{{journeyInfo.checkMoney + ' ' + journeyInfo.settleCurrency}}</span></p>
            </div>
            ...
            <div v-if="toConfirmedList.length !== 0">
              ...
              <div v-if="toConfirmedSel.select == 1">
                ...
                <div class="details-top" style="margin: 30px auto;">
                  <p>
                    预估报销金额：<span>{{formatNumberRgx(toConfirmedDetails.sysCheckMoney) + ' ' + toConfirmedDetails.settleCurrency}}</span>
                  </p>
                  <p>
                    核算报销金额：<span>{{formatNumberRgx(toConfirmedDetails.checkMoney) + ' ' + toConfirmedDetails.settleCurrency}}</span>
                  </p>
                </div>
                <div class="details-main">
                  ...
                  <table v-for="(reim,index) in toConfirmedDetails.data" :key="index">
                    ...
                    <tr>
                      ...
                      <td>{{formatNumberRgx(reim.obj.checkMoney) + ' ' + toConfirmedDetails.settleCurrency}}</td>
                      <td>
                        <p v-if="reim.type == 0" style="margin: 0;">{{reim.obj.startTime}}</p>
                        <p v-if="reim.type == 0" style="margin: 0;">至</p>
                        <p v-if="reim.type == 0" style="margin: 0;">{{reim.obj.endTime}}</p>
                          ...
                          <div>
                            ...
                            <div style="margin-top: 20px;border-top: 1px solid #ddd;">
                              ...
                              <div style="padding-left: 15px;display: flex;justify-content: space-between;">
                                ...
                                <img src="../../assets/imgs/calc2.png" style="height: 35px;cursor: pointer;"
                                  @click="jumpRate(unJourneyInfo2.rateTime)" />
                              </div>
                              ...
                              <p style="padding-left: 15px;">
                                ...
                                预估报销金额：<span>{{formatNumberRgx(unJourneyInfo2.sysCheckMoney) + ' ' + unJourneyInfo2.settleCurrency}}</span>
                              </p>
                              <p style="padding-left: 15px;">
                                核算报销金额：<span>{{formatNumberRgx(unJourneyInfo2.checkMoney) + ' ' + unJourneyInfo2.settleCurrency}}</span>
                              </p>
                            </div>
                          </div>
                          <div slot="footer">
              ...
              <div v-if="toConfirmedSel.select == 2">
                  ...
                  <table>
                    ...
                    <tr v-for="(every,index) in journeyInfo2.recordList" :key="index">
                      ...
                      <td>
                        ...
                        {{formatNumberRgx(every.checkMoney) + ' ' + journeyInfo2.settleCurrency}}
                      </td>
                      <td>{{every.time}}</td>
                      <td>
                        <el-tooltip class="item" effect="light" content="查看详情" placement="top-end">
                          ...
                          <div>
                            ...
                            <div style="margin-top: 20px;border-top: 1px solid #ddd;">
                              ...
                              <div style="padding-left: 15px;display: flex;justify-content: space-between;">
                                ...
                                <img src="../../assets/imgs/calc2.png" style="height: 35px;cursor: pointer;"
                                  @click="jumpRate(recordDetailsMsg2.rateTime)" />
                              </div>
                              <p style="margin-top: 0;padding-left: 15px;">
                              ...
                              <p style="padding-left: 15px;">
                                ...
                                预估报销金额：<span>{{formatNumberRgx(recordDetailsMsg2.sysCheckMoney) + ' ' + journeyInfo2.settleCurrency}}</span>
                              </p>
                              <p style="padding-left: 15px;">
                                核算报销金额：<span>{{formatNumberRgx(recordDetailsMsg2.checkMoney) + ' ' + journeyInfo2.settleCurrency}}</span>
                              </p>
                            </div>
                          </div>
                          <div slot="footer">
                ...
                <div style="width: 95%;margin: 0 auto;">
                  ...
                  <p style="margin-left: 20px;">
                    ...
                    预估报销金额：<span>{{formatNumberRgx(journeyInfo2.sysCheckMoney) + ' ' + journeyInfo2.settleCurrency}}</span>
                  </p>
                  <p style="margin-left: 20px;">
                    核算报销金额：<span>{{formatNumberRgx(journeyInfo2.checkMoney) + ' ' + journeyInfo2.settleCurrency}}</span>
                  </p>
                </div>
              </div>
            </div>
...
<script>
  export default {
    ...
    props: ['reimbursementAdminSel', 'jumpToRate'],
    mounted() {
      console.log(this.reimbursementAdminSel.select);
      console.log('------------' + this.jumpToRate.selectval);
      if (this.jumpToRate.selectval == 13) { //判断是否是汇率页面跳转回来的数据
        this.activeName = sessionStorage.getItem('setactiveName')
        if (this.activeName === 'one') {
          this.reimburseDetails(sessionStorage.getItem('Detailsbxnumber'))
          console.log(sessionStorage.getItem('lookOvertype'), sessionStorage.getItem('lookOverid'));

        } else if (this.activeName === 'two') {
          this.handleConfirmedDetails(sessionStorage.getItem('Detailsbxnumber2'));
          console.log(sessionStorage.getItem('lookOvertype2'), sessionStorage.getItem('lookOverid2'));
    ...
    methods: {
      ...
      reimburseDetails(bxNumber) {
        sessionStorage.setItem('Detailsbxnumber', bxNumber)
        this.records = [];
        this.checked = false;
        this.$axios.post(this.$store.state.baseUrl + '/ClaimFormInfo?java', {
          ...
          this.lookOver(sessionStorage.getItem('lookOvertype'), sessionStorage.getItem('lookOverid'));
          if (this.reimbursementAdminSel.select == 2) {
            this.recordDetails(sessionStorage.getItem('recorevery'))
          }
        }).catch((err) => {
          console.log(err);
        })
      ...
      // 查看行程/非行程信息
      lookOver(type, id) {
        sessionStorage.setItem('lookOvertype', type)
        sessionStorage.setItem('lookOverid', id)
        console.log(type, id);
        this.auditId = '';
        ...
        if (type == 0) {
          ...
          this.$axios.post(this.$store.state.baseUrl + '/RecordInfo?java', {
            ...
            sessionStorage.setItem('toconfirmedsel', 1)
            this.$emit('deleteReco', 0);
          }).catch((err) => {
            console.log(err);
          });
        }
      ...
      // 查看行程信息记录详情
      recordDetails(every) {
        sessionStorage.setItem('recorevery', every)
        this.calculationAmount = '';
        console.log(every);
      ...
      handleConfirmedDetails(bxNumber) {
        sessionStorage.setItem('Detailsbxnumber2', bxNumber)
        this.$axios.post(this.$store.state.baseUrl + '/ClaimFormInfo?java', {
          bxNumber: bxNumber
        }).then((res) => {
          console.log('报销单详情');
          ...
          if (this.jumpToRate.selectval == 13) {
            this.lookOver2(sessionStorage.getItem('lookOvertype2'), sessionStorage.getItem('lookOverid2'));
            this.toConfirmedSel.select = sessionStorage.getItem('toconfirmedsel')
            if (this.toConfirmedSel.select == 2) {
              console.log(this.toConfirmedSel.select);
              this.recordDetails2(JSON.parse(sessionStorage.getItem('recorevery2')))
            }
          }
        }).catch((err) => {
          console.log(err);
      ...
      // 获取行程/非行程详细信息
      lookOver2(type, id) {
        sessionStorage.setItem('lookOvertype2', type)
        sessionStorage.setItem('lookOverid2', id)
        console.log(type, id);
        if (type == 0) {
          this.$axios.post(this.$store.state.baseUrl + '/TripInfo?java', {
            id: id
            ...
            sessionStorage.setItem('toconfirmedsel', this.toConfirmedSel.select)
          }).catch((err) => {
            console.log(err);
          });
        } else if (type == 1) {
      ...
      recordDetails2(every) {
        sessionStorage.setItem('recorevery2', JSON.stringify(every))
        ...
        console.log(this.dialogRecordDetailsVisible2);
        this.$emit('deleteReco', 0);
      },
      // 分页
      ...
      jumpRate(time) {
        //待处理
        sessionStorage.setItem('reimbursementselect', this.reimbursementAdminSel.select)
        this.$emit('rateCalcJump', 13, time, 1);
      },
      gobackList() {
        this.reimbursementAdminSel.select = 0;
      },
      ...
      handleTabsClick() {
        this.page = 1;
        this.keyword = '';
        sessionStorage.setItem('setactiveName', this.activeName)
        ...
        if (this.jumpToRate.selectval != '') {
          this.reimbursementAdminSel.select = sessionStorage.getItem('reimbursementselect');
          console.log(this.reimbursementAdminSel.select + "-0001");
        } else {
          this.reimbursementAdminSel.select = 0;
          console.log(this.reimbursementAdminSel.select + "-1112");
        }
        this.toConfirmedSel.select = 0;
