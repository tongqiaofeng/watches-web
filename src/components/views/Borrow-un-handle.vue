        ...
        <tr v-for="(item,index) in borrowUnList" :key="index">
          ...
          <td>
            <div style="display: flex;justify-content: center;">
              ...
              <el-tooltip class="item" effect="light" content="审核该申请" placement="top-end">
                <img src="../../assets/imgs/check.png" style="width: 22px;height: 22px;cursor: pointer;"
      ...
      <div class="un-handle-msg">
        ...
        <div class="msg-main">
          ...
          <div class="main-message">
            ...
            <p><span>申请人：</span><span>{{borrowUnHandleRecord.obj.operatorNick}}</span></p>
    ...
    methods: {
      ...
      borrowDealMatters(id) {
        ...
        if (a1.every(val => a2.includes(val))) {
          ...
          this.$emit('signBorrowUn', 0);
        } else {
          this.$emit('signBorrowUn', 1);
        }
