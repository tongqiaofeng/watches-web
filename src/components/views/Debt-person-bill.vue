    ...
    <div v-show="completedRecordList.length !== 0">
      <table v-for="(item,index) in list" :key="index" class="borrow-table">
        ...
        <tr>
          ...
          <td>{{item.time}}</td>
          <td>
            <p :style="{color: item.type == 1 || item.type == 4 ? '#0c7063' : 'red'}">
              {{item.type == 1 || item.type == 4 ? '+' +formatNumberRgx(item.money) + ' ' +item.currency : '-' +formatNumberRgx(item.money) + ' ' +item.currency}}
            </p>
          </td>
          <td>
            ...
            <el-dialog title="记录详情" v-if="dialogCompletedRecordDetailsOneVisible == true"
              ...
              <div>
                <div class="un-handle-msg">
                  ...
                  <p class="msg-top" style="color: #0c7063;">
                  ...
                  <div class="msg-main">
                    ...
                    <div class="main-message">
                      ...
                      <p><span>申请对象：</span><span>{{completedHandleRecord.obj.userNick}}</span></p>
            ...
            <el-dialog title="记录详情" v-if="dialogCompletedRecordDetailsThreeVisible == true"
              ...
              <div>
                <div class="un-handle-msg">
                  ...
                  <p class="msg-top" style="color: red;">
                    {{'- ' + formatNumberRgx(completedHandleRecord.obj.subMoney) + ' ' +completedHandleRecord.obj.currency}}
                  </p>
                  <div class="msg-main">
                    <p>申请信息：</p>
                  ...
                  <div class="msg-main">
                    ...
                    <div class="main-message">
                      <p>
                        ...
                        <span>收款人：</span><span>{{completedHandleRecord.obj.payeeNick}}</span>
                      </p>
                      <p>
                        <span>转账时间：</span><span>{{completedHandleRecord.obj.payTime}}</span>
                      </p>

                      <div style="display: flex;">转账描述：<p v-html="completedHandleRecord.obj.describe"
                          style="margin-top: 0;">
                        </p>
                      </div>
                      <div style="display: flex;">
            ...
            <el-dialog title="记录详情" v-if="dialogCompletedRecordDetailsFiveVisible == true"
              :visible.sync="dialogCompletedRecordDetailsFiveVisible" center>
              <div>
                <div class="un-handle-msg">
                  <p class="msg-top" style="color: #0c7063;">
                    {{'+ ' +formatNumberRgx(completedHandleRecord.obj.payMoney) + ' ' +completedHandleRecord.obj.currency}}
                  ...
                  <div class="msg-main">
                    ...
                    <div class="main-message">
                      <p>
                        <span>转账人：</span><span>{{completedHandleRecord.obj.transferNick}}</span>
                      </p>
                      <p>
                        <span>转账时间：</span><span>{{completedHandleRecord.obj.payTime}}</span>
                      </p>
              ...
              <div slot="footer">
                <el-button @click="dialogCompletedRecordDetailsFiveVisible = false">取 消</el-button>
                <el-button type="primary" @click="dialogCompletedRecordDetailsFiveVisible = false">确 定</el-button>
              </div>
            </el-dialog>
          </td>
        </tr>
  ...
  export default {
    data() {
      return {
        ...
        dialogCompletedRecordDetailsFiveVisible: false,
        recordType: '',
      ...
      deletedViewDetails(id, type) {
        ...
        this.$axios.post(this.url + '/borrowRecordInfo?java', {
          ...
          switch (type) {
            ...
            case 4:
              this.dialogCompletedRecordDetailsFiveVisible = true;
              break;
          };
        }).catch(err => {
          console.log(err);
