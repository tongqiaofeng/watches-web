        ...
        <tr>
          ...
          <td>
            <div
              ...
              :style="item.type | filterImg" @click="dealMatters(item.id,item.type)">
              {{item.type == 1 ? '向我借款' : (item.type == 2 ? '我的借款' : '向我转账')}}</div>
          </td>
        </tr>
      </table>
      ...
      <div class="un-handle-msg">
        ...
        <div class="msg-main">
          ...
          <div class="main-message">
            ...
            <p><span>申请人：</span><span>{{unHandleRecord.obj.operatorNick}}</span></p>
      ...
      <div class="un-handle-msg">
        ...
        <div class="msg-main">
          ...
          <div class="main-message">
            ...
            <p><span>申请对象：</span><span>{{unHandleRecord.obj.userNick}}</span></p>
            <p><span>申请时间：</span><span>{{unHandleRecord.obj.subTime}}</span></p>
            <p><span>申请原因：</span><span>{{unHandleRecord.obj.describe}}</span></p>
            <div style="display: flex;">
              <span>收款账户：</span>
      ...
      <div class="un-handle-msg">
        ...
        <div class="msg-main">
          ...
          <div class="main-message">
            ...
            <p><span>转账人：</span><span>{{unHandleRecord.obj.transferNick}}</span></p>
