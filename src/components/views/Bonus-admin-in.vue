      ...
      <table>
        ...
        <tr v-for="(item, index) in list" :key="index">
          ...
          <td>
            ...
            <el-dialog
              title="删除该分红单"
              :visible.sync="dialogDeleteBonusVisible"
              center
            >
              ...
              <div slot="footer">
                <el-button @click="dialogDeleteBonusVisible = false"
                  >取 消</el-button
                >
                <el-button type="primary" @click="deleteBonusSure"
                  >确 定</el-button
                >
              </div>
            </el-dialog>
      ...
      <div>
        ...
        <div style="margin-left: 20px;">
          ...
          <div class="bonus-every-style">
            <p>资金：</p>
            <div
              style="width: 143px;display: flex;justify-content: space-around;"
            >
              <p>
                <img :src="bonusDetails.bonusMsg.fundFlag >= 1 ? img1 : img2" />
              </p>
          ...
          <div class="bonus-every-style">
            ...
            >
              <p>
                <img
                  :src="bonusDetails.bonusMsg.companyFlag >= 1 ? img1 : img2"
                />
              </p>
              <p style="margin-left: 15px;">
                <img
                  :src="bonusDetails.bonusMsg.companyFlag == 2 ? img1 : img2"
                />
              </p>
            </div>
          </div>
          <div class="bonus-every-style">
            ...
            >
              <p>
                <img
                  :src="bonusDetails.bonusMsg.purchaseFlag >= 1 ? img1 : img2"
                />
              </p>
              <p style="margin-left: 15px;">
                <img
                  :src="bonusDetails.bonusMsg.purchaseFlag == 2 ? img1 : img2"
                />
              </p>
            </div>
          </div>
                  ...
                  >
                    <div v-if="dialogWatchDetailsVisible == true">
                      <div
                        :style="{
                          color:
                            watchDetailsCon.sellMoney -
                              watchDetailsCon.checkCost >
                            0
                              ? '#0c7063'
                              : 'red',
                          margin: '10px 0',
                      ...
                      <div>
                        ...
                        <div style="margin-left: 20px;">
                          ...
                          <p>
                            ...
                            <span>{{
                              formatNumberRgx(
                                watchDetailsCon.purchase.logMoney
                              ) +
                                " " +
                                watchDetailsCon.currency
                            }}</span>
...
export default {
  ...
  methods: {
    ...
    deleteBonusSure() {
      this.$axios
        .post(this.$store.state.baseUrl + "/bonusFormDelete?java", {
          id: this.deleteId,
        })
        .then((res) => {
          console.log("删除该分红单");
    ...
    getList() {
      ...
      this.list = this.inBonusList.filter(
        (item, index) =>
