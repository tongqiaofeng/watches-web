    ...
    <div class="login-container-main">
      <div class="login-bottom">
        <div class="every-img">
          ...
          <div
            ref="qrcode1"
            style="position: absolute;left: 110%;bottom: 10px;display: none;z-index: 999;"
          >
            <img
      ...
      if (this.loginForm.user == "" || this.loginForm.psw == "") {
        ...
        this.$axios
          ...
          .then((res) => {
            ...
            sessionStorage.setItem("authority", res.data.authorityFlag);
            console.log(sessionStorage.getItem("authority"));
            sessionStorage.setItem("userRecordId", res.data.nick);
            sessionStorage.setItem(
              "authorityGroupList",
              JSON.stringify(res.data.authorityGroupList)
            );
            sessionStorage.setItem(
              "authorityList",
              JSON.stringify(res.data.authorityList)
            );
            sessionStorage.setItem(
              "companyLoginCurrency",
              res.data.companyCurrency
            );
