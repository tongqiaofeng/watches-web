      ...
      <div class="details-contentbox">
        <div class="message-mainbox">
          ...
          <div class="mainbox-block">
            ...
            <span>销售金额 :</span
            ><span>{{
              formatNumberRgx(sellinfoList.sellMoney) +
                " " +
                sellinfoList.sellCurrency
            }}</span>
          </div>
          <div class="mainbox-block">
            <img
        ...
        <div class="message-mainbox">
          ...
          <div class="mainbox-block">
            ...
            <span>付款金额* :</span
            ><span>{{
              formatNumberRgx(sellinfoList.sellPayMoney1) +
                " " +
                sellinfoList.sellCurrency
            }}</span>
          </div>
        ...
        <div class="message-mainbox" v-if="sellinfoList.sellPayFull == 0">
          ...
          <div class="mainbox-block">
            ...
            <span>付款金额* :</span
            ><span>{{
              formatNumberRgx(sellinfoList.sellPayMoney2) +
                " " +
                sellinfoList.sellCurrency
            }}</span>
          </div>
        ...
        <div class="message-mainbox">
          <p>
            {{ sellinfoList.sellNote == "" ? "无" : sellinfoList.sellNote }}
          </p>
        ...
        >
          <img
            src="../../assets/imgs/warehouse.png"
            alt=""
            style="background-color: #0c7063;border-radius: 4px;"
            class="messagelogo"
          />
