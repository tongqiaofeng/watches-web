<template>
  <div id="completed-container">
    ...
    <div class="for-sale-list-container">
      <div>
        <div
          v-show="forSaleWatchList.length == 0"
        ...
        <div v-if="forSaleWatchList.length !== 0">
          <div
            v-for="(item, index) of forSaleWatchList"
            :key="index"
                ...
                <td>
                  ...
                  >
                    <img
                      ...
                      @click="sellWatch(item)"
                    />
                  </el-tooltip>
                  <el-dialog
                    title="详细信息"
                    :visible.sync="dialogSaleListVisible"
                    center
                  >
                      ...
                      <div>
                        <el-form label-width="120px">
                          <el-form-item label="型号：">
                            <span>{{
                              detailsInfo.buyWatchBrand +
                                " - " +
                                detailsInfo.buyWatchModel
                            }}</span>
                          </el-form-item>
                      ...
                      <div style="margin-bottom: 40px;">
                        <el-form label-width="120px">
                          ...
                          <el-form-item label="送货人：">
                            <span>{{ sellSendUserNick }}</span>
                          </el-form-item>
                        </el-form>
                      </div>
                    </div>
                    <div slot="footer">
                      <el-button @click="dialogSaleListVisible = false"
                        >取 消</el-button
                      >
                      <el-button
                        type="primary"
                        @click="dialogSaleListVisible = false"
                        >确 定</el-button
                      >
                    </div>
                  </el-dialog>
    ...
    getSellOrderList() {
      ...
      this.$axios
        .post(this.$store.state.baseUrl + "/SellOrderList", {
          ...
          userId: sessionStorage.getItem("saleUserIdSaled"),
        })
        .then((res) => {
          console.log("已完成销售");
          console.log(res);
